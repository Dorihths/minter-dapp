...
const OWNER_ADDRESS = '0x34ac578288378CA0ce3BFc3c5D1Da5dfe65009C6';
const TREASURY_ADDRESS = '0x34ac578288378CA0ce3BFc3c5D1Da5dfe65009C6';
...
const PUBLIC_MINT_START_DATE = "2022-04-23T22:00:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = null; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 1000; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x24422C2bc305862a1BaB2798800c0dd21cAdC668"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = []; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x19BE2a39783683E4Fea33aE17eB74daa2Ad7e47c"; // If you want to manually include it
